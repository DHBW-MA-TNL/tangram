...
public class LevelShapes{
    public List<TangramShape> levelShapes= new ArrayList<>();
    public LevelShapes(){
        int multiplier = 2;
        ...
        levelShapes.add(new TangramShape(Q1, Color.GRAY));
        levelShapes.add(new TangramShape(P1, Color.GRAY));
    }
    ...
    public List<TangramShape> getlevelShapes(){
        return levelShapes;
    }
}